...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateLiveSitePreview() {
    ...
    const classicalSvg = '<svg class="w-48 sm:w-56 h-auto text-[#9b8265] mx-auto opacity-85" viewBox="0 0 320 80" xmlns="http://www.w3.org/2000/svg"><path d="M 160,8 C 163,16 167,23 170,27 C 166,27 162,28 160,32 C 158,28 154,27 150,27 C 153,23 157,16 160,8 Z" fill="currentColor"/><path d="M 158,27 C 152,24 148,19 149,14 C 151,19 155,23 158,25.5 Z" fill="currentColor"/><path d="M 162,27 C 168,24 172,19 171,14 C 169,19 165,23 162,25.5 Z" fill="currentColor"/><rect x="154" y="32" width="12" height="2" rx="1" fill="currentColor"/><path d="M 160,37 C 155,37 148,43 148,51 C 148,58 153,62 157,62 C 160,62 162,60 162,57 C 162,54 159,52 157,53 C 155,54 154,56 155,58" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" fill="none"/><path d="M 160,37 C 165,37 172,43 172,51 C 172,58 167,62 163,62 C 160,62 158,60 158,57 C 158,54 161,52 163,53 C 165,54 166,56 165,58" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" fill="none"/><path d="M 160,40 C 145,39 125,43 105,48 C 85,53 68,54 62,50 C 58,47 62,42 70,42 C 78,42 84,47 88,48" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" fill="none"/><path d="M 105,48 C 95,44 86,37 80,36 C 73,35 68,39 67,43 C 66,49 75,54 84,54 C 95,54 112,47 130,45" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" fill="none"/><path d="M 148,44 C 138,40 128,34 124,34 C 120,34 118,37 121,39 C 124,41 132,43 140,46" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" fill="none"/><circle cx="92" cy="42" r="1.2" fill="currentColor"/><circle cx="96" cy="40" r="1" fill="currentColor"/><circle cx="100" cy="39" r="0.8" fill="currentColor"/><path d="M 68,43 C 65,38 72,33 78,35 C 74,37 72,40 70,43 Z" fill="currentColor"/><path d="M 160,40 C 175,39 195,43 215,48 C 235,53 252,54 258,50 C 262,47 258,42 250,42 C 242,42 236,47 232,48" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" fill="none"/><path d="M 215,48 C 225,44 234,37 240,36 C 247,35 252,39 253,43 C 254,49 245,54 236,54 C 225,54 208,47 190,45" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" fill="none"/><path d="M 172,44 C 182,40 192,34 196,34 C 200,34 202,37 199,39 C 196,41 188,43 180,46" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" fill="none"/><circle cx="228" cy="42" r="1.2" fill="currentColor"/><circle cx="224" cy="40" r="1" fill="currentColor"/><circle cx="220" cy="39" r="0.8" fill="currentColor"/><path d="M 252,43 C 255,38 248,33 242,35 C 246,37 248,40 250,43 Z" fill="currentColor"/></svg>';
    const modernSvg = '<svg class="w-48 sm:w-56 h-auto text-[#9b8265] mx-auto opacity-85" viewBox="0 0 320 60" xmlns="http://www.w3.org/2000/svg"><path d="M 160,25 C 158,16 151,10 144,10 C 137,10 132,15 133,21 C 134,26 140,29 145,26 C 149,23 148,18 144,18 C 142,18 140,20 141,22" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" fill="none"/><path d="M 160,25 C 162,16 169,10 176,10 C 183,10 188,15 187,21 C 186,26 180,29 175,26 C 171,23 172,18 176,18 C 178,18 180,20 179,22" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" fill="none"/><path d="M 148,25 C 130,32 105,33 85,28 C 76,26 68,26 62,30 C 60,31 63,33 66,33 C 75,33 88,32 105,37 C 122,41 140,36 156,28" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" fill="none"/><path d="M 135,28 C 115,31 95,29 78,25 C 70,23 64,24 60,28" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" fill="none"/><path d="M 60,28 C 58,30 59,33 63,32 C 60,32 59,30 60,28 Z" fill="currentColor"/><path d="M 172,25 C 190,32 215,33 235,28 C 244,26 252,26 258,30 C 260,31 257,33 254,33 C 245,33 232,32 215,37 C 198,41 180,36 164,28" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" fill="none"/><path d="M 185,28 C 205,31 225,29 242,25 C 250,23 256,24 260,28" stroke="currentColor" stroke-width="1.0" stroke-linecap="round" fill="none"/><path d="M 260,28 C 262,30 261,33 257,32 C 260,32 261,30 260,28 Z" fill="currentColor"/></svg>';
